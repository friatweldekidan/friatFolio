...
export default function Home() {
  ...
  return (
    <div className="min-h-[379px] pt-12  bg-contain bg-right  bg-no-repeat" style={{backgroundImage: `url("assets/img/bg.jpg")`}}>
      <div className="max-w-4xl mx-auto font-mono">
        ...
        >
          ...
          <motion.p
            ...
            className="text-4xl text-center text-gray-600 my-12"
          >
            Frontend Developer
          </motion.p>
